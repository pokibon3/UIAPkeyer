			...
			for(uint8_t mode=0;mode<(SSD1306_H>32?9:8);mode++)
			{
				...
				switch(mode)
				{
					case 0:
						...
						for(int i=0;i<(int)sizeof(ssd1306_buffer);i++)
							ssd1306_buffer[i] = i;
						break;
					...
					case 5:
						...
						ssd1306_drawstr(0,0, (char *)"This is a test", 1);
						ssd1306_drawstr(0,8, (char *)"of the emergency", 1);
						ssd1306_drawstr(0,16,(char *)"broadcasting", 1);
						ssd1306_drawstr(0,24,"system.",1);
						if(SSD1306_H>32)
						{
							ssd1306_drawstr(0,32, (char *)"Lorem ipsum", 1);
							ssd1306_drawstr(0,40, (char *)"dolor sit amet,", 1);
							ssd1306_drawstr(0,48, (char *)"consectetur", 1);
							ssd1306_drawstr(0,56, (char *)"adipiscing",1);
						}
					...
					case 6:
						...
						ssd1306_drawstr_sz(0,0, (char *)"sz 8x8", 1, fontsize_8x8);
						ssd1306_drawstr_sz(0,16, (char *)"16x16", 1, fontsize_16x16);
						break;
					
					case 7:
						printf("Scaled Text 4\n\r");
						ssd1306_drawstr_sz(0,0, (char *)"32x32", 1, fontsize_32x32);
						break;
					
					
					case 8:
//						const uint8_t text[] = { 'ｱ', 'ｲ',0};
						printf("Scaled Text 8\n\r");
//						ssd1306_drawstr_sz(0,0, text, 1, fontsize_64x64);
						for (uint8_t c = 0xb1; c <= 0xdd; c++){
							ssd1306_drawchar_sz(32,0, c, 1, fontsize_64x64);
							ssd1306_refresh();
							Delay_Ms(200);
						}
						break;
